...
public class Pool {
    ...
    final static int n = 600;  // number of customers/passengers
    final static int n_stands = 50; // check gendemand.py !!
    final static int MAX_IN_POOL = 4;  // how many passengers can a cab take
    final static int MAX_WAIT_TIME = 3; // how many 'minutes' (time entities) want a passenger to wait for a cab
